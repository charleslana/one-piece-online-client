...
const menus: Menu[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Maestrias', to: '/' },
      { label: 'Alcunhas', to: '/' },
      { label: 'Listar de amigos', to: '/' },
      { label: 'Localizador de amigos', to: '/' },
      { label: 'Modo História', to: '/' },
      { label: 'Objetivos', to: '/' },
      { label: 'Passe de Batalha', to: '/' },
      { label: 'Profissão', to: '/' },
      { label: 'Recompensas', to: '/' },
      { label: 'Loteria', to: '/' },
      { label: 'Talentos', to: '/' },
      { label: 'Golpe avançado', to: '/' },
    ],
  },
  {
    title: 'Treinamento',
    disabled: false,
    items: [
      { label: 'Treinamento de Atributos', to: '/' },
      { label: 'Aprender Golpes', to: '/' },
      { label: 'Aprimorar Golpes', to: '/' },
      { label: 'Transformar', to: '/' },
      { label: 'Tutorial', to: '/' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      { label: 'Caçadas', to: '/' },
      { label: 'Equipamentos', to: '/' },
      { label: 'Eventos', to: '/' },
      { label: 'Fórum', to: '/' },
      { label: 'Guerra de mares', to: '/' },
      { label: 'Objetivos', to: '/' },
      { label: 'Loja', to: '/' },
      { label: 'Pacotes', to: '/' },
      { label: 'Usopp Factory', to: '/' },
      { label: 'Forja', to: '/' },
      { label: 'Status do mar', to: '/' },
      { label: 'Votação dos Conselheiros', to: '/' },
      { label: 'Hospital', to: '/' },
      { label: 'Mercado', to: '/' },
      { label: 'Mercador', to: '/' },
      { label: 'Trabalho', to: '/' },
  ...
  },
  {
    ...
    disabled: false,
    items: [
      { label: 'Histórico de Batalhas', to: '/' },
      { label: 'Ilha', to: '/' },
      { label: 'Battlesea', to: '/' },
      { label: 'Boss', to: '/' },
      { label: 'Duelo', to: '/' },
  ...
  },
  {
    ...
    disabled: false,
    items: [
      { label: 'Lista de Itens', to: '/' },
      { label: 'Lista de Drops', to: '/' },
      { label: 'Livro de Akumas', to: '/' },
      { label: 'Relatório de Drops', to: '/' },
      { label: 'Relatório de Mar Aberto', to: '/' },
      { label: 'Relatório de Metas', to: '/' },
      { label: 'Relatório de PVP', to: '/' },
      { label: 'Relatório de Tripulação', to: '/' },
    ],
  },
];
